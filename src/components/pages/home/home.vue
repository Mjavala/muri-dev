    ...
    <div id="home-wrap">
        ...
        <div id="stations-dropdown">
            ...
            <p><B>Recent Data Summary Links: (Not auto-generated)</B><BR /></p>
                <!--LI><A HREF="https://irisslive.net/muri_live/#/muri/historical&2020-08-21%20xbee_0013A20041B485A9&BARN1">COLORADO - 08/21/2020 - BARN1</A></LI>
                <LI><A HREF="https://irisslive.net/muri_live/#/muri/historical&2020-08-18%20xbee_0013A20041B4841D&BARN1">COLORADO - 08/18/2020 - BARN1</A></LI>
            ...
            <span id="quick_links"></span>
            <div><v-img id="iriss-logo" class="responsive-img" max-width="250" src="../../../assets/iriss_logo.jpg" /></div>
        </div>
...
export default {
    ...
    mounted() {
        var fName = "https://irisslive.net/muri_quick_links.txt";
        
        fetch(fName, {mode: 'no-cors'})
            .then( r => r.text() )
            .then( t => {
                console.log("Got Quick Links" + t)
                document.getElementById("quick_links").innerHTML = t;
                //$("#quick_links").html(t);
            });
    },
}
