<template>
    ...
    <div>
      <v-app-bar app flat id="nav" height=100 class="hidden-xs-only">
        <v-img class="responsive-img" max-width="250" src="../../../assets/hyflits_home.png" />
         <v-spacer />
        ...
        <v-spacer />
          ...
          <v-btn  id="dgrs-logs" light small>
            ...
            <a class="links" href="https://irisslive.net/muri_data_vol/?dir=dgrs" target="_blank">DGRS Log Files</a>
          </v-btn>
